...
![A.R.C.E.](https://img.shields.io/badge/Framework-A.R.C.E.-2563EB?style=for-the-badge)
![Bloom's](https://img.shields.io/badge/Based_on-Bloom's_Taxonomy-10B981?style=for-the-badge)
...
```mermaid
flowchart TB
    subgraph LO["🎯 Learning Outcomes"]
        LO1["LO1: วิเคราะห์ปัญหา"]
        LO2["LO2: ให้เหตุผลสนับสนุน"]
        LO3["LO3: เสนอแนวทางแก้ไข"]
    end
    
    subgraph ACT["📚 Learning Activities"]
        ACT1["กิจกรรม 5E Model"]
        ACT2["Chat-based Discussion"]
        ACT3["Electronic Worksheet"]
    end
    
    subgraph ASSESS["📝 Assessment"]
        ASSESS1["A.R.C.E. Scoring"]
        ASSESS2["AI Evaluation"]
        ASSESS3["LO Attainment Check"]
    end
    
    subgraph FB["💬 Feedback"]
        FB1["Immediate AI Feedback"]
        FB2["Adaptive Scaffolding"]
        FB3["Progress Tracking"]
    end
    ...
    style LO fill:#e0f2fe
    style ACT fill:#dcfce7
    style ASSESS fill:#fef3c7
    style FB fill:#f3e8ff
```
